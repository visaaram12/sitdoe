...
$result1 = mysqli_query($conn, "SELECT * FROM login WHERE username='$uname' && status='Y' ");
  ...
  box-sizing: border-box;
    ...
    <body>
         <?php include './head.php'; ?>
           <h2 class = "engraved" style="width: 100%"> TECHNICAL ENGLISH AND COMMUNICATIVE ENGLISH
                </h2> 
    ...
    <form method="post" autocomplete="off">
      ...
      <a href="pwd.php">Forgot Password/Reset Password </a>
    </form>
