...
$otp = $_POST['otp'];
echo $otp;
$result1= mysqli_query($conn, "SELECT * FROM manuals_login WHERE uname='$_SESSION[uname]' ");
...
* {
  box-sizing: border-box;
    ...
    <form method="post" autocomplete="off" action="">
      ...
      <input type="submit" class="fadeIn fourth" value="Submit" name="login" style="font-size: 12px;padding: 4px">
