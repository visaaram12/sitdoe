...
if (isset($_POST['submit1'])) {
    $query = "SELECT MAX(sno) AS sno FROM checklist";
    ...
    $query1 = "Insert into checklist (document,status )
...
<html>
    ...
    <body>
        ...
        <br><br> 
    <center>  <h1 class="engraved" style="font-size: 15px; font-family: Century Schoolbook;color: blue">CHECKLIST
        </h1></center>
            ...
            <form  method='POST' action="" enctype="multipart/form-data" autocomplete="off">
                <div >
                    <table   style="font-size: 12px; border:1px solid; border-collapse: collapse;" >
                        ...
                        <tbody class="tbody">
                            <?php
                            $result = mysqli_query($conn, "SELECT * FROM checklist order by sno desc ");
