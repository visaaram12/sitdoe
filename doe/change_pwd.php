...
$query1 =  "update  manuals_login set pwd='$psw' WHERE uname='$_SESSION[uname]' ";
...
//{
 // header("Location:record/checklist.php");  
//}
}
...
* {
  box-sizing: border-box;
    ...
    <form method="post" autocomplete="off">
      <input type="text" id="login" class="fadeIn second" name="pwd" placeholder="Password">
      <input type="password" id="pwd" class="fadeIn third" name="c_pwd" placeholder="Confirm password">
      <input type="submit" class="fadeIn fourth" value="Change Password" name="login">
